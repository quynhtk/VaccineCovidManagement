...
namespace VaccineCovidManagement.Web.Pages.NhaSanXuats
{
    public class EditModalModel : VaccineCovidManagementPageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var vaccineSanXuatExist = await _nhaSanXuatAppService.CheckTenVaccineSanXuatExist(EditNhaSanXuats.TenVaccineSX);
            ...
            {
                throw new UserFriendlyException(L["Nhà sản xuất " + EditNhaSanXuats.TenNhaSX + " và Vaccine " + EditNhaSanXuats.TenVaccineSX + " đã tồn tại"]);
            }
            return NoContent();
        }
